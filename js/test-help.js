...
function displayTestHelp(currentTestHelp) {
  ...
  let text = currentTestHelp + '/10';
  testPageNum.text(text);

  switch (currentTestHelp) {

    case 1:
      testHelpText.html('<h1>Welcome to Triad Trials!</h1> <p class="help-p">This simple web app is a virtual playground for learning about and testing your knowledge of triads, the basic building blocks of chords.</p>');
      break;
    case 2:
