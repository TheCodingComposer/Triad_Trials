...
function displayHelp(currentHelp) {
  ...
  switch (currentHelp) {
    ...
    case 3:
      ...
      // helpText.html('<h1>Keyboard Hotkeys</h1>     <img src="images/computer_keyboard.jpeg" style="width: 350px;"> </img>    <p style="">The "Computer Keys" toggle (1) and the "Note Names" toggle (2)</p> ');
      break;
    case 4:
      helpText.html('<h1>Show Computer Keys/Notes</h1> <img src="images/note-toggle.png" style="width: 17%; float: left;">    </img>          <div style="">  <p class="help-p-med" style="margin-left:30%;">The "Computer Keys" toggle (1) allows you to show or hide the computer keys associated with each piano keys. </br> </br> The "Note Names" toggle (2) allows you to show or hide the note names for each piano key.</p> </div>   <img class="help-image-resize" src="images/keyboard-notes.png" style="width: 390px; margin-top: 15px"></img>')
      break;
    case 5:
      helpText.html('<h1>Music Staff</h1> <img src="images/staff.png" style="width: 100px; float: left; margin-right:15px">    </img>            <p class="help-p-med"">The "Music Staff" region shows where notes are located on a conventional music staff. By default, accidentals are shown as sharps. Press the 4 key to display accidentals as flats, and press the 3 key to return to sharps.</p><br><p class="help-p-med">Press the 5 key to continue displaying notes on the staff after the sound has stopped.')
      break;
    case 6:
      helpText.html('<h1>Triad Input</h1> <img src="images/input.png" style="width: 300px; margin-bottom:15px">  </img>            <p class="help-p" style="">Click on the "Root" dropdown to choose the root note of a chord (C, C#, etc.) and the "Quality" dropdown to choose the chord quality (Major, Minor, etc.). Click "Get Triad" to hear the triad played on the virtual piano and displayed in the staff box.</p> <br> <p class="help-p-med"> Note that a triad belonging to a sharp key will change the music staff display to sharps, and a triad belonging to a sharp key will change the display to flats.')
      break;
